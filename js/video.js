		...
		success : function(data) {
			if (data.result == 'OK') {
				...
				for (var i = 0; i < 3; i++) {
					...
					if(i==0||i==1||i==2)
					{
						str	+='<video controls="" name="media" class="video-list" src="http://vali-g1.cp31.ott.cibntv.net/youku/69752e30609387173282e501c/03000801005ED0E635F6204003E880EAF120E3-FC36-4F82-A448-5E34401D7A65.mp4?sid=159212567300010004125_00_B54712ec8006757e140762bf6c08f5dd7&amp;sign=beefe9d075ef0e2d21a32f31bedc26f6&amp;ctype=50&amp;si=183&amp;psid=713850910b6824a787ce59f500f54be24d045">'
					}
...
function intVideoOne(){
	videoTimeOne=setInterval(function(){
		...
		$('#slider1').animate({'left':-550},1000,function(){
